...
collaborationRouter.patch("/organization/profile", requireAuth, async (req, res) => {
  ...
  try{await client.query("BEGIN");
    await client.query(`UPDATE organizations SET description=$1,district=$2,address=$3,latitude=$4,longitude=$5 WHERE id=$6`,[d.description,d.district??null,d.address??null,d.latitude??null,d.longitude??null,req.auth!.organizationId]);
